                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-3">
                                    <h5 class="text-dark">Welcome Back ! </h5><span></span>
                                    <p class = "text-dark">{{auth()->user()->displayname}}</p>
                                </div>
                            </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <h5 class="font-size-15 text-white">Henry Price</h5>
